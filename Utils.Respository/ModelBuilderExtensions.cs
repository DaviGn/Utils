...
namespace Utils.Repository
{
    ...
    {
        public static void ApplyConfigurationsFromAssembly(this ModelBuilder modelBuilder, Assembly assembly, string configNamespace = "")
        {
            ...
            var applicableTypes = assembly.GetTypes().Where(c => c.IsClass && !c.IsAbstract && !c.ContainsGenericParameters);
...
#if DEBUG
                        Console.WriteLine("Applied mapping " + type.Name);
#endif
